...
static const pair <string, string> fanPath[] ={
    make_pair("/sys/bus/i2c/devices/i2c-8/8-0020/hwmon/","pwm1"),
    make_pair("/sys/bus/i2c/devices/i2c-8/8-0020/hwmon/","pwm2"),
    make_pair("/sys/bus/i2c/devices/i2c-8/8-0020/hwmon/","pwm3"),
    make_pair("/sys/bus/i2c/devices/i2c-8/8-0023/hwmon/","pwm1"),
    make_pair("/sys/bus/i2c/devices/i2c-8/8-0023/hwmon/","pwm2"),
    make_pair("/sys/bus/i2c/devices/i2c-8/8-0023/hwmon/","pwm3"),
    make_pair("/sys/bus/i2c/devices/i2c-8/8-002e/hwmon/","pwm1"),
    make_pair("/sys/bus/i2c/devices/i2c-8/8-002e/hwmon/","pwm2")
};
...
ipmi::RspType<uint8_t> ipmiOemSetFanPwm(uint8_t fanId, uint8_t pwm)
{
    ...
    auto pwmDirVec = getDirFiles(fanPath[fanId].first, "hwmon[0-9]+");
    if (pwmDirVec.size() != 1)
    {
        phosphor::logging::log<phosphor::logging::level::INFO>(
    ...
    auto pwmFilePath = pwmDirVec[0] + "/" + fanPath[fanId].second;
...
{
    phosphor::logging::log<phosphor::logging::level::INFO>(
        "Registering INV Starscream OEM commands");
